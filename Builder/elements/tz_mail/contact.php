...
if($_POST)
{
	...
	$input_extra = $value;
	if(isset($input_extra[key($input_extra)])){
	...
	if(!empty($g_secret_key) && (!empty($value['g-recaptcha-response'])))
	{
		...
		if($results['success'] == 1)
		{
			// API FUNCTION CALL //
				...
				{
					case 'tz_aweber':
						themezaa_aweber($subscribe_email,$user_name,$last_name,$phone_num,$comment,$msg_subscribed_success,$msg_invalid_api);
						break;
					case 'tz_active':
						themezaa_activecampaign($subscribe_email,$user_name,$msg_subscribed_success,$msg_invalid_api,$last_name,$phone_num,$comment);
						break;
					case 'tz_custom':
						...
						break;
					case 'tz_campain':
						themezaa_campaign($subscribe_email,$user_name,$last_name,$phone_num,$comment,$msg_subscribed_success,$msg_invalid_api);
						break;
					case 'tz_response':
	...
	function themezaa_campaign($subscribe_email,$user_name,$last_name=NULL,$phone_num=NULL,$comment=NULL,$msg_subscribed_success,$msg_invalid_api)
	{
	...
	function themezaa_aweber($subscribe_email,$user_name,$last_name=NULL,$phone_num=NULL,$comment=NULL,$msg_subscribed_success,$msg_invalid_api)
	{
	...
	function themezaa_activecampaign($subscribe_email,$user_name,$msg_subscribed_success,$msg_invalid_api,$last_name=NULL,$phone_num=NULL,$comment=NULL)
	{
	...
	function themezaa_mailerlite($subscribe_email,$user_name,$last_name=NULL,$phone_num=NULL,$comment=NULL,$msg_subscribed_success,$msg_invalid_api)
	{
